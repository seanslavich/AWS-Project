...
op_10_output = s3_destination(op_4_output['default'], spark=spark, **{'output_config': {'compression': 'none', 'output_path': 's3://ml-analytics-data-2022/Test-wrangler/', 'output_content_type': 'CSV', 'delimiter': ','}})
op_11_output = encode_categorical(op_4_output['default'], spark=spark, **{'operator': 'One-hot encode', 'one_hot_encode_parameters': {'invalid_handling_strategy': 'Keep', 'drop_last': False, 'output_style': 'Columns', 'input_column': ['hircand_Role', 'hircand_Type', 'hircand_Level', 'hircand_Preferred_Time', 'hircand_Preferred_Day', 'hiremp_Role', 'hiremp_Type', 'hiremp_Level', 'hiremp_Preferred_Time', 'hiremp_Preferred_Day', 'emp_skill']}, 'ordinal_encode_parameters': {'invalid_handling_strategy': 'Replace with NaN', 'input_column': ['hircand_Role', 'hircand_Type', 'hircand_Level', 'hircand_Preferred_Time', 'hircand_Preferred_Day', 'hiremp_Role', 'hiremp_Type', 'hiremp_Level', 'hiremp_Preferred_Time', 'hiremp_Preferred_Day', 'emp_skill']}})
op_12_output = encode_categorical(op_11_output['default'], spark=spark, **{'operator': 'Ordinal encode', 'ordinal_encode_parameters': {'invalid_handling_strategy': 'Replace with NaN', 'input_column': ['Accepted_or_Not?']}})
op_13_output = split(op_12_output['default'], spark=spark, **{'operator': 'Randomized split', 'randomized_split_parameters': {'splits': [{'name': 'Train', 'percentage': 0.8}, {'name': 'Test', 'percentage': 0.2}], 'error': 0.0001}})
...
#
#  op_1_output: 70ae51e0-f3ea-4d47-b664-71afe7a24296
#  op_2_output: d76072d2-1ed5-4f1d-a3ce-bb8b8bee3f44
#  op_4_output: 190d964b-b7e7-4353-9ab9-35048d70febc
...
#  op_10_output: 62284c82-8dea-4f79-8b34-457fc4de02a9
#  op_11_output: e2a324b6-8463-4f48-bd38-210c3d046bc4
#  op_12_output: d964b0ad-2384-45b9-9bac-b306eea487dd
#  op_13_output: 5b5d2d3c-b2d7-4274-97e3-c6cee487e87f
#  op_14_output: 63fc326e-7470-4efc-9c21-a6aba229e3bd
#  op_15_output: 19bda406-fd67-4733-8f11-5f3d97554df2
